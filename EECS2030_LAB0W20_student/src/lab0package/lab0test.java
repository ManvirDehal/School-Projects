	  ...
	  @Test
		public void test04() {
	       ...
	       // System.out.println("ia1 contains (a)?" + lab0.contains(ia1,a));
			...
			assertEquals("1", true, lab0.contains(ia1,a));
			assertEquals("2", false, lab0.contains(ia1,43));
			
			 int[] aa = {3}; 
			 assertEquals("3", true, lab0.contains(aa,3)); 
			 assertEquals("4", false, lab0.contains(aa,43));
		}
